    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" method="POST" action="../function/inputdata2.php">

                    <div class="form-group">
                        <label class="control-label">Nama Customer</label>
                        <div>
                            <input type="text" class="form-control input-lg" placeholder="Masukkan Nama Customer..." name="nm_pel">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Alamat Customer</label>
                        <div>
                            <input type="text" class="form-control input-lg" placeholder="Masukkan Alamat Customer..." name="almt_pel">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="text" class="form-control input-lg" placeholder="Telepon Customer" name="telp_pel">
                </div>
            </div>
